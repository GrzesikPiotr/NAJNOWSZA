...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Zarejestrowani Nauczyciele</h3>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <!-- CONTENT -->
                       <?php 
                                  ...
                                  $rezultat = mysql_query("SELECT * FROM nauczyciel order by idprzedmiotu ASC") or die(mysql_error());
                                 ...
                                 echo "<th ><strong>Przedmiot nauczania</strong></th>";
                                 echo "</tr>";
