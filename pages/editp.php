...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>PANEL ADMINISTRATORA - usuwanie przedmiotu</h3>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <!-- CONTENT -->
                            <?php
                                    ...
                                    $q="DELETE FROM `przedmioty` WHERE `idprzedmiotu` = '{$_GET['usun']}'";
                                        mysql_query($q);
                                    $rezultat = mysql_query("SELECT * FROM `przedmioty`") or die("Błąd 2");
                                    $wykonaj = mysql_num_rows($rezultat);
                                    echo "<p>Ilość przedmiotów w szkole = ".$wykonaj."</p>";
                                   ...
                                   while ($record = mysql_fetch_array($rezultat, MYSQL_ASSOC))  {
                                      echo "</tr>";
                                      echo "<td >" . $record['przedmiot'] . "</td>";

                                      echo "<td >  <h4><a href=\"editp.php?usun={$record['idprzedmiotu']}\"><img src=\"../images/del.png\" alt=\"Usuń\" name=\"Usuń\" title=\"Usuń\"></a>&nbsp&nbsp<a href=\"?dzial=admin&poddzial=edytujusera\"><img src=\"../images/edit.png\" alt=\"Edytuj\" name=\"Edytuj\" title=\"Edytuj\"></a></h4> </td>";
                                      echo "</tr>";
                                   }
                                   echo "</table>";
