<?php
    class user {
        ...
        public function getData ($login, $pass) {
            ...
            self::$user = mysql_fetch_array(mysql_query("SELECT * FROM wychowawca WHERE login='$login' AND pass='$pass' LIMIT 1;"));
            return self::$user;
        }
         ...
         * @return array 
         */
        public function getDataById ($idwychowawcy) {
            $user = mysql_fetch_array(mysql_query("SELECT * FROM wychowawca WHERE id='$idwychowawcy' LIMIT 1;"));
            return $user;
        }
