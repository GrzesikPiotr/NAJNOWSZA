...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>PANEL ADMINISTRATORA - usuwanie wychowawcy</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <!-- CONTENT -->
                             <?php
                                    $q="DELETE FROM `wychowawca` WHERE `idwychowawcy` = '{$_GET['usun']}'";
                                    mysql_query($q);
                                    $rezultat = mysql_query("SELECT * FROM wychowawca order by idwychowawcy ASC") or die(mysql_error());
                                   ...
                                   while ($record = mysql_fetch_array($rezultat, MYSQL_ASSOC))  {
                                      ...
                                      echo "<td >  <h4><a href=\"editwych.php?usun={$record['idwychowawcy']}\"><img src=\"../images/del.png\" alt=\"Usuń\" name=\"Usuń\" title=\"Usuń\"></a>&nbsp&nbsp</h4> </td>";
                                      echo "</tr>";
                                   }
                                   echo "</table>";
