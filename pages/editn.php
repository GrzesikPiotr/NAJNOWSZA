...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>PANEL ADMINISTRATORA - usuwanie nauczyciela</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <!-- CONTENT -->
                             <?php
                                    $q="DELETE FROM `nauczyciel` WHERE `idnauczyciela` = '{$_GET['usun']}'";
                                    mysql_query($q);
                                    $rezultat = mysql_query("SELECT * FROM nauczyciel order by idnauczyciela ASC") or die(mysql_error());
                                    $wykonaj = mysql_num_rows($rezultat);
                                    echo "<p>Ilość Nauczycieli: ".$wykonaj."</p>";
                                   ...
                                   echo "<th ><strong>Przedmiot prowadzony</strong></th>";
                                   ...
                                   while ($record = mysql_fetch_array($rezultat, MYSQL_ASSOC))  {
                                      ...
                                      echo "<td >" . $record['wyksztalcenie'] . "</td>";
                                      echo "<td >" . $record['idprzedmiotu'] . "</td>";
                                      echo "<td >" . $record['telefon'] . "</td>";
                                      echo "<td >  <h4><a href=\"editn.php?usun={$record['idnauczyciela']}\"><img src=\"../images/del.png\" alt=\"Usuń\" name=\"Usuń\" title=\"Usuń\"></a>&nbsp&nbsp</h4> </td>";
                                      echo "</tr>";
                                   }
                                   echo "</table>";
