...
<?php
    $_SESSION['uczen2']=$_POST['uczen2'];
    $_SESSION['dzien2']=$_POST['dzien2'];
?>
    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <!-- CONTENT -->
                <h3><center>Edycja obecność - Semestr II<br/>Klasa:  
                 <?php
                 ...
                 ?>
                    ...
                    <?php
                        if ($_POST['send'] == 1) {
                            ...
                            $dzien2 = mysql_real_escape_string(htmlspecialchars($_POST['dzien2']));

                            $errors = ''; // Zmienna przechowująca listę błędów które wystąpiły

                            if (!$uczen2 || !$dzien2) $errors .= '<h4><center> Musisz wybrać ucznia!</h4></center><br />';
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: ../nauczyciel/editobecnosc_wui2.php\n\n");                                 
                            }
                        }
                    
                    ?>

                    <center><form action="../nauczyciel/editobecnosc_wui2.php" method="post">
                    <label for="uczen2">Proszę wybrać ucznia do edycji obecności:<br/> 
                    <?php                 
                    ...
                    <label for="dzien2"><strong>Pokaż obecność z dnia:</strong><input id="dzien2" name="dzien2" size="37" style="text-align: center"/></label><br /> 

                    <script type="text/javascript" src="datepickr.min.js"></script>
                    <script type="text/javascript">
                      new datepickr('dzien2', {
                        'dateFormat': 'y/m/d'
                      });
                    </script>
                    <br />
