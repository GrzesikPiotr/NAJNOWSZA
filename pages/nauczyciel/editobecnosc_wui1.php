            ...
            <div class="content">
                ...
                <?php
                        if (user::isLogged()) {
                            ...
                            echo "<center>Semestr: <b>I</b></center><br/>";
                            echo "<center>Nauczyciel: <b>".$user['imie']. " " .$user['nazwisko']."</b></center><br/>";
                            echo "<center>Przedmiot nauczania: <b>".$user['idprzedmiotu']."</b></center><br/>";
                            echo "<center>Wybrana klasa: <b>" .$_SESSION['klasa']. "</b></center><br/>";
                            echo "<center>Wybrany uczeń: <b>" .$_SESSION['uczen1']. "</b></center><br/>";
                            echo "<center>Wybrany dzień: <b>" .$_SESSION['dzien1']. "</b></center><br/>";
                            echo "<center><a href=\"../nauczyciel/edycjaobecnosc_s1.php\"><button>Popraw obecność</button></a>
                            <a href=\"../nauczyciel/usunobecnosc_s1.php\"><button>Usuń obecność</button></a></center>"; 
                        }
