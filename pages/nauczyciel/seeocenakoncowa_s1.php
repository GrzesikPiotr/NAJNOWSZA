...
<div id="wrap">
    ...
    <div class="page">
        ...
        <!-- CONTENT -->
            <h3><center>Lista ocen końcowych - Semestr I<br/>Klasa:  
                 <?php
                 ...
                 ?>
                    ...
                    <?php                       
                           ...
                           $zapytanie = "SELECT * FROM ocenakoncowa_s1 WHERE idklasy='{$_SESSION['klasa']}' and idprzedmiotu='{$user['idprzedmiotu']}' order by iducznia DESC";
