            ...
            <div class="content">
                ...
                <?php
                        if (user::isLogged()) {
                            ...
                            echo "<center>Semestr: <b>II</b></center><br/>";
                            ...
                            echo "<center>Wybrany uczeń: <b>" .$_SESSION['uczen2']. "</b></center><br/>";
                            echo "<center><a href=\"../nauczyciel/edycjaocena_s2.php\"><button>Popraw ocenę</button></a>
                            <a href=\"../nauczyciel/usunocena_s2.php\"><button>Usuń ocenę</button></a></center>"; 
                        }
