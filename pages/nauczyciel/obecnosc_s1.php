...
<div id="wrap">
    ...
    <div class="page">
        ...
        <!-- CONTENT -->
            <h3><center>Wprowadzanie obecności - Semestr I<br/>Klasa:  
                 <?php
            ...
            // Zapisz dane do bazy
            mysql_query("INSERT INTO obecnosc_s1 (iducznia, idklasy, idnauczyciela, idprzedmiotu, obecnosc, data_obecnosci) VALUES ('$iducznia', '$klasa', '$imie $nazwisko', '$idprzedmiotu', '$obecnosc', NOW())") or die ('<p class="error">Wystąpił błąd w zapytaniu i nie udało się wprowadzić.</p>');
