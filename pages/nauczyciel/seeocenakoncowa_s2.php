...
<div id="wrap">
    ...
    <div class="page">
        ...
        <!-- CONTENT -->
            <h3><center>Lista ocen końcowych - Semestr II<br/>Klasa:  
                 <?php
                 ...
                 ?>
                    ...
                    <?php                       
                           ...
                           $zapytanie = "SELECT * FROM ocenakoncowa_s2 WHERE idklasy='{$_SESSION['klasa']}' and idprzedmiotu='{$user['idprzedmiotu']}' order by iducznia DESC";
