            ...
            <div class="content">
                ...
                <?php
                        if (user::isLogged()) {
                            ...
                            echo "<center>Wybrany dzień: <b>" .$_SESSION['dzien2']. "</b></center><br/>";
                            echo "<center><a href=\"../nauczyciel/edycjaobecnosc_s2.php\"><button>Popraw obecność</button></a>
                            <a href=\"../nauczyciel/usunobecnosc_s2.php\"><button>Usuń obecność</button></a></center>"; 
                        }
