    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>
                 <?php
                      echo "Usuwanie oceny - Semestr II<br/>";
                ...
                ?>
                            ...
                            <?php
                                $q="DELETE FROM `ocena_s2` WHERE `idoceny` = '{$_GET['usun']}'";
                                mysql_query($q);
                                $rezultat = mysql_query("SELECT * FROM ocena_s2 WHERE idklasy='{$_SESSION['klasa']}' and iducznia='{$_SESSION['uczen2']}' and idprzedmiotu='{$user['idprzedmiotu']}' order by idoceny, rodzaj_oceny ASC") or die(mysql_error());
                                ...
                                echo "<th><strong>Notatka oceny</strong></th>";
                                echo "<th><strong>Data wystawienia</strong></th>";
                                echo "<th><strong>Usuń</strong></th>";
                                echo "</tr>";
                                $i = 0;
                                ...
                                while ($record = mysql_fetch_array($rezultat, MYSQL_ASSOC))  {
                                    ...
                                    echo "<td>" . $record['rodzaj_oceny'] . "</td>";
                                    echo "<td>" . $record['tresc_oceny'] . "</td>";
                                    echo "<td>" . $record['data_oceny'] . "</td>";
                                    echo "<td>  <h4><a href=\"../nauczyciel/usunocena_s2.php?usun={$record['idoceny']}\"><img src=\"../../images/del.png\" alt=\"Usuń\" name=\"Usuń\" title=\"Usuń\"></a></h4></td>";
                                    echo "</tr>";
                                    $i++;
                                }
                                echo "</table>";
                                echo "Wystawiono łącznie: ".$wykonaj." ocen";
                                echo "</center>";
