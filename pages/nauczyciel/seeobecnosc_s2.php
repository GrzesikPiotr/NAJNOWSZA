    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>Dzień:  
                   <?php
                        echo "<font color=\"red\">" . $_SESSION['dzien2'] . "&nbsp</font>";
                        echo "<a href=\"../nauczyciel/seeobecnosc_s2wb.php\"><button>Wybierz nową datę</button></a>";                          
                   ?>
                </center></h3><br />

                      <?php                       
                           //Definiujemy zapytanie pobierające wszystkie wiersze z wszystkimi
                           $zapytanie = "SELECT * FROM obecnosc_s2 WHERE idklasy='{$_SESSION['klasa']}' and data_obecnosci='{$_SESSION['dzien2']}' and idprzedmiotu='{$user['idprzedmiotu']}' order by iducznia ASC";
                           ...
                           echo "<a href=\"../nauczyciel/nauczycielindex.php\"><button>Panel Nauczyciela</button></a><br/><br/>";
                      ?>
