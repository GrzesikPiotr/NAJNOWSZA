        ...
        <div class="page-wrap">
            <div class="content">
                 ...
                 ?>
		                ...
		                <?php
							...
							if(isset($_POST['obecnosc']))
							{
							  ...
							  if(mysql_query("INSERT INTO obecnosc_s1 VALUES('$obecnosc')"))
							...
							$res = mysql_query("SELECT * FROM obecnosc_s1 WHERE idklasy='{$_SESSION['klasa']}' and iducznia='{$_SESSION['uczen1']}' and idprzedmiotu='{$user['idprzedmiotu']}' and data_obecnosci='{$_SESSION['dzien1']}' ");
                ...
                echo "</tr>";
                  ...
                  echo "<td><h4><a href='editobecnosc_s1.php?editobecnosc_s1=$row[idobecnosci]'><img src=\"../../images/edit.png\" alt=\"Edytuj\"></a></h4> </td>";
                  echo "</tr>";
                }
                echo "</table>";
                echo "</center>";
