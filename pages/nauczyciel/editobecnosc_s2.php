        ...
        <div class="page-wrap">
            <div class="content">
                ...
                ?>
                 ...
                 <?php
                      echo "Edycja obecności - Semestr II<br/>";
                ...
                <?php
						...
						if( isset($_GET['editobecnosc_s2']) )
						{
							$idobecnosci = $_GET['editobecnosc_s2'];
							$res= mysql_query("SELECT * FROM obecnosc_s2 WHERE idobecnosci='$idobecnosci'");
						...
						if( isset($_POST['newObecnosc']))
						{
							...
							$sql     = "UPDATE obecnosc_s2 SET obecnosc='$newObecnosc' WHERE idobecnosci='$idobecnosci'";
							$res 	 = mysql_query($sql) or die("Could not update" .mysql_error());
							echo "<meta http-equiv='refresh' content='0;url=edycjaobecnosc_s2.php'>";
						}
					...
					<?php
          echo '<center>
          <form action="editobecnosc_s2.php" method="POST">
