    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <!-- CONTENT -->
                <h3><center>Edycja obecność - Semestr I<br/>Klasa:  
                 <?php
                 ...
                 ?>
                    ...
                    <?php
                        if ($_POST['send'] == 1) {
                            ...
                            if (!$uczen1 || !$dzien1) $errors .= '<h4><center> Musisz wybrać ucznia!</h4></center><br />';
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: ../nauczyciel/editobecnosc_wui1.php\n\n");                                 
                            }
                        }
                    
                    ?>

                    <center><form action="../nauczyciel/editobecnosc_wui1.php" method="post">
                    <label for="uczen1">Proszę wybrać ucznia do edycji obecności:<br/> 
                    <?php                 
