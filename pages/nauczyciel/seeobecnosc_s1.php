    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>Dzień:  
                   <?php
                        echo "<font color=\"red\">" . $_SESSION['dzien1'] . "&nbsp</font>";
                        echo "<a href=\"../nauczyciel/seeobecnosc_s1wb.php\"><button>Wybierz nową datę</button></a>";                          
                   ?>
                </center></h3><br />

                      <?php                       
                           //Definiujemy zapytanie pobierające wszystkie wiersze z wszystkimi
                           $zapytanie = "SELECT * FROM obecnosc_s1 WHERE idklasy='{$_SESSION['klasa']}' and data_obecnosci='{$_SESSION['dzien1']}' and idprzedmiotu='{$user['idprzedmiotu']}' order by iducznia ASC";
