        ...
        <div class="page-wrap">
            <div class="content">
                ...
                ?>
                 ...
                 <?php
                      echo "Usuwanie obecności - Semestr I<br/>";
                 ...
                 ?>
                            ...
                            <?php
                                $q="DELETE FROM `obecnosc_s1` WHERE `idobecnosci` = '{$_GET['usun']}'";
                                mysql_query($q);
                                $rezultat = mysql_query("SELECT * FROM obecnosc_s1 WHERE idklasy='{$_SESSION['klasa']}' and iducznia='{$_SESSION['uczen1']}' and idprzedmiotu='{$user['idprzedmiotu']}' and data_obecnosci='{$_SESSION['dzien1']}' order by idobecnosci ASC") or die(mysql_error());
                                ...
                                while ($record = mysql_fetch_array($rezultat, MYSQL_ASSOC))  {
                                    ...
                                    echo "<td>  <h4><a href=\"../nauczyciel/usunobecnosc_s1.php?usun={$record['idobecnosci']}\"><img src=\"../../images/del.png\" alt=\"Usuń\" name=\"Usuń\" title=\"Usuń\"></a></h4></td>";
                                    echo "</tr>";
                                    $i++;
                                }
                                echo "</table>";
