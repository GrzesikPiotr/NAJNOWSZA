                ...
                <h3><center>Oceny Klasy:  
                   ...
                   <?php
                        if (user::isLogged()) {
                            ...
                            echo "<br/>Przedmiot: <font color=\"red\">".$user['idprzedmiotu']."</font></center>";
                        }
                    ?>
                </center></h3><br />
                    ...
                    <?php 
                          ...
                          $rezultat = mysql_query("SELECT DISTINCT(iducznia) FROM ocena_s1 where idklasy='{$_SESSION['klasa']}' order by iducznia ASC") or die(mysql_error());
                           ...
                           while ($record = mysql_fetch_array($rezultat))  {
                              ...
                              echo "<td style=\"width: 25%\"><b>" . $record['iducznia'] . "</b></td>";
                                ...
                                $rezultat2 = mysql_query("SELECT * FROM ocena_s1 where iducznia='{$record['iducznia']}' and idprzedmiotu='{$user['idprzedmiotu']}'; ") or die(mysql_error());
