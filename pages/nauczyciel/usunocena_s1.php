    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>
                 <?php
                      echo "Usuwanie oceny - Semestr I<br/>";
                ...
                ?>
                            ...
                            <?php
                                $q="DELETE FROM `ocena_s1` WHERE `idoceny` = '{$_GET['usun']}'";
                                mysql_query($q);
                                $rezultat = mysql_query("SELECT * FROM ocena_s1 WHERE idklasy='{$_SESSION['klasa']}' and iducznia='{$_SESSION['uczen1']}' and idprzedmiotu='{$user['idprzedmiotu']}' order by idoceny, rodzaj_oceny ASC") or die(mysql_error());
                                ...
                                while ($record = mysql_fetch_array($rezultat, MYSQL_ASSOC))  {
                                    ...
                                    echo "<td>  <h4><a href=\"../nauczyciel/usunocena_s1.php?usun={$record['idoceny']}\"><img src=\"../../images/del.png\" alt=\"Usuń\" name=\"Usuń\" title=\"Usuń\"></a></h4></td>";
                                    echo "</tr>";
                                    $i++;
                                }
                                echo "</table>";
