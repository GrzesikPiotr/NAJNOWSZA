        ...
        <div class="page-wrap">
            <div class="content">
                ...
                ?>
                 ...
                 <?php
                      echo "Edycja obecności - Semestr I<br/>";
                      echo "Klasa: <font color=\"red\">" . $_SESSION['klasa'] . "</font><br/>";
                      echo "Uczeń: <font color=\"red\">" . $_SESSION['uczen1'] . "</font><br/>";
                      echo "Przedmiot: <font color=\"red\">".$user['idprzedmiotu']."</font><br/><br/>";
                      echo "Dzień: <font color=\"red\">" . $_SESSION['dzien1'] . "</font>";                    
                 ?>
                </center></h3><br />
                ...
                <?php
						...
						if( isset($_GET['editobecnosc_s1']) )
						{
							$idobecnosci = $_GET['editobecnosc_s1'];
							$res= mysql_query("SELECT * FROM obecnosc_s1 WHERE idobecnosci='$idobecnosci'");
							$row= mysql_fetch_array($res);
						}
					 
						if( isset($_POST['newObecnosc']))
						{
							$newObecnosc = $_POST['newObecnosc'];
							
							$idobecnosci  	 = $_POST['idobecnosci'];
							$sql     = "UPDATE obecnosc_s1 SET obecnosc='$newObecnosc' WHERE idobecnosci='$idobecnosci'";
							$res 	 = mysql_query($sql) or die("Could not update" .mysql_error());
							echo "<meta http-equiv='refresh' content='0;url=edycjaobecnosc_s1.php'>";
						}
					...
					<?php
          echo '<center>
          <form action="editobecnosc_s1.php" method="POST">


                        <select name="newObecnosc">
                            <option>' .$row['obecnosc']. '</option>
          ...
          <input type="hidden" name="idobecnosci" value="'.$row['idobecnosci'].'">
          <button><input type="hidden" value="Update"/>Update</button>
                    ...
                    <br/>
                        ...
                        <a href="../nauczyciel/editobecnosc_wu1.php"><button>Zmień ucznia</button></a><br />
                    <br/>
                <!-- END CONTENT -->
