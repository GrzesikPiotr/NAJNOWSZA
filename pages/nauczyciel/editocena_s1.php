    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>
                 <?php
                      echo "Poprawianie oceny - Semestr I<br/>";
                      echo "Klasa: <font color=\"red\">" . $_SESSION['klasa'] . "</font><br/>";
                      echo "Uczeń: <font color=\"red\">" . $_SESSION['uczen1'] . "</font>";                    
                 ?>
                ...
                <?php
						...
						if( isset($_GET['editocena_s1']) )
						{
							$idoceny = $_GET['editocena_s1'];
							$res= mysql_query("SELECT * FROM ocena_s1 WHERE idoceny='$idoceny'");
						...
						if( isset($_POST['newOcena']) && $_POST['newRodzaj_oceny'] && $_POST['newTresc_oceny'])
						{
							...
							$sql     = "UPDATE ocena_s1 SET ocena='$newOcena', rodzaj_oceny='$newRodzaj_oceny', tresc_oceny='$newTresc_oceny' WHERE idoceny='$idoceny'";
							$res 	 = mysql_query($sql) or die("Could not update" .mysql_error());
							echo "<meta http-equiv='refresh' content='0;url=edycjaocena_s1.php'>";
						}
					...
					<?php
          echo '<center>
          <form action="editocena_s1.php" method="POST">
          ...
          <button><input type="hidden" value="Update"/>Update</button>
                    ...
                    <br/>
                        ...
                        <a href="../nauczyciel/editocena_wu1.php"><button>Zmień ucznia</button></a><br />
                    <br/>
                <!-- END CONTENT -->
