    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <!-- CONTENT -->
                <h3><center>Edycja oceny - Semestr II<br/>Klasa:  
                 <?php
                 ...
                 ?>
                    ...
                    <?php
                        if ($_POST['send'] == 1) {
                            ...
                            if (!$uczen2) $errors .= '<h4><center> Musisz wybrać ucznia!</h4></center><br />';
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: ../nauczyciel/editocena_wui2.php\n\n");                                 
                            }
                        }
                    
                    ?>

                    <center><form action="../nauczyciel/editocena_wui2.php" method="post">
                    <label for="uczen2">Proszę wybrać ucznia do edycji oceny:<br/> 
                    <?php                 
