...
<div id="wrap">
    ...
    <div class="page">
        ...
        <!-- CONTENT -->
            <h3><center>Wystawianie oceny końcowej - Semestr I<br/>Klasa:  
                 <?php
            ...
            if (isset ($_POST['send'] )){
            $uczen1 = mysql_real_escape_string(htmlspecialchars($_POST['uczen1']));
            ...
            $ocena_sem1 = mysql_real_escape_string(htmlspecialchars($_POST['ocena_sem1']));
            $zachowanie1 = mysql_real_escape_string(htmlspecialchars($_POST['zachowanie1']));
            ...
            $errors = ''; // Zmienna przechowująca listę błędów które wystąpiły
                                        ...
                                        if (!$uczen1 || !$ocena_sem1 || !$zachowanie1 ) $errors .= '<center><h4>Musisz wypełnić wszystkie pola</h4></center><br />';
                                        /**
            ...
            // Zapisz dane do bazy
            mysql_query("INSERT INTO ocenakoncowa_s1 (iducznia, idklasy, idprzedmiotu, idnauczyciela, ocena_sem, zachowanie, data_wystawienia) VALUES ('$uczen1', '$klasa', '$idprzedmiotu', '$imie $nazwisko', '$ocena_sem1', '$zachowanie1', 
              NOW())") or die ('<p class="error">Wystąpił błąd w zapytaniu i nie udało się dodać oceny końcowej.</p>');
            echo "<p class=\"success\"><center><b>Uczeń <font color=\"red\" size=\"4\">".$uczen1."</font> otrzymał/a ocenę końcową:<br/> 
            Ocena: <font color=\"red\" size=\"4\">".$ocena_sem1."</font><br/> 
            Zachowanie: <font color=\"red\" size=\"4\">".$zachowanie1."</font></b></center></p>";
              ...
              <tr>
                <td valign="top">
                    ...
                    <table cellspacing="1" border="2" style="width: 35%">
                        ...
                        <tr style="text-align: center" bgcolor="#333333">
                            <!-- Ocena semestralna -->
                            <td><label for="ocena_sem1">
                                <select name="ocena_sem1">
                        ...
                        <tr style="text-align: center" bgcolor="#333333">
                            <!-- Zachowanie -->
                            <td><label for="zachowanie1">
                                <select name="zachowanie1">
                ...
                <td valign="top">
                    <?php                       
                           ...
                           $zapytanie = "SELECT * FROM ocena_s1 WHERE idklasy='{$_SESSION['klasa']}' and idprzedmiotu='{$user['idprzedmiotu']}' order by iducznia, rodzaj_oceny DESC";
