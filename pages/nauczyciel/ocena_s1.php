...
<div id="wrap">
    ...
    <div class="page">
        ...
        <!-- CONTENT -->
            <h3><center>Dodawanie oceny - Semestr I<br/>Klasa:  
                 <?php
            ...
            // Zapisz dane do bazy
            mysql_query("INSERT INTO ocena_s1 (iducznia, idklasy, idprzedmiotu, ocena, rodzaj_oceny, tresc_oceny, idnauczyciela, data_oceny) VALUES ('$uczen', '$klasa', '$idprzedmiotu', '$ocena', '$rodzaj_oceny', '$tresc_oceny', '$imie $nazwisko', NOW())") or die ('<p class="error">Wystąpił błąd w zapytaniu i nie udało się dodać oceny.</p>');
