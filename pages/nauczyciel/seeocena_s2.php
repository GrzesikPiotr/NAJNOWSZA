                ...
                <h3><center>Oceny Klasy:  
                   ...
                   <?php
                    ...
                    <?php 
                          ...
                          $rezultat = mysql_query("SELECT DISTINCT(iducznia) FROM ocena_s2 where idklasy='{$_SESSION['klasa']}' order by iducznia ASC") or die(mysql_error());
                           ...
                           while ($record = mysql_fetch_array($rezultat))  {
                              ...
                              echo "<td style=\"width: 30%\"><b>" . $record['iducznia'] . "</b></td>";
                              
                                $rezultat2 = mysql_query("SELECT * FROM ocena_s2 where iducznia='{$record['iducznia']}' and idprzedmiotu='{$user['idprzedmiotu']}'; ") or die(mysql_error());
