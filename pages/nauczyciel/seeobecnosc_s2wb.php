...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Nauczyciela - Obecność</h3>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <?php
                        if ($_POST['send'] == 1) {
                            ...
                            if (!$dzien2) $errors .= '<h4><center> Musisz wybrać dzień!</h4></center><br />';
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: seeobecnosc_s2.php\n\n");                                 
                            }
                        }
                    ?>


                <form method="post" action="seeobecnosc_s2.php">
                    <center>                  
