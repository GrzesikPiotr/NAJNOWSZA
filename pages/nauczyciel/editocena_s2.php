    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>
                 <?php
                      echo "Poprawianie oceny - Semestr II<br/>";
                      echo "Klasa: <font color=\"red\">" . $_SESSION['klasa'] . "</font><br/>";
                      echo "Uczeń: <font color=\"red\">" . $_SESSION['uczen2'] . "</font>";                    
                 ?>
                 ...
                 <?php
                    if (user::isLogged()) {
                            ...
                            echo "<br/>Przedmiot: <font color=\"red\">".$user['idprzedmiotu']."</font>";
                        }
                ?>
                </center></h3><br />
                ...
                <?php
						...
						if( isset($_GET['editocena_s2']) )
						{
							$idoceny = $_GET['editocena_s2'];
							$res= mysql_query("SELECT * FROM ocena_s2 WHERE idoceny='$idoceny'");
							$row= mysql_fetch_array($res);
						}
					 
						if( isset($_POST['newOcena']) && $_POST['newRodzaj_oceny'] && $_POST['newTresc_oceny'])
						{
							$newOcena = $_POST['newOcena'];
							$newRodzaj_oceny = $_POST['newRodzaj_oceny'];
							$newTresc_oceny = $_POST['newTresc_oceny'];
							
							$idoceny  	 = $_POST['idoceny'];
							$sql     = "UPDATE ocena_s2 SET ocena='$newOcena', rodzaj_oceny='$newRodzaj_oceny', tresc_oceny='$newTresc_oceny' WHERE idoceny='$idoceny'";
							$res 	 = mysql_query($sql) or die("Could not update" .mysql_error());
							echo "<meta http-equiv='refresh' content='0;url=edycjaocena_s2.php'>";
						}
					...
					<?php
          echo '<center>
          <form action="editocena_s2.php" method="POST">
          ...
          <td><center><input type="text" name="newOcena" maxlength="2" style="width: 30px; text-align: center" value="'.$row['ocena'].'"></center></td>

          <td><center><label for="newRodzaj_oceny">
                        <select name="newRodzaj_oceny">
                            <option>' .$row['rodzaj_oceny']. '</option>
          ...
          <td><center><input type="text" name="newTresc_oceny" style="width: 500px; text-align: center" value="'.$row['tresc_oceny'].'"></center></td>
          
          </tr>
          </table>
          <input type="hidden" name="idoceny" value="'.$row['idoceny'].'">
          <button><input type="hidden" value="Update"/>Update</button>
          </form></center>';
					?>

                    <br/>
                        <a href="../nauczyciel/nauczycielindex.php"><button>Panel Nauczyciela</button></a>
                        <a href="../nauczyciel/editocena_wu2.php"><button>Zmień ucznia</button></a><br />
                    <br/>
                <!-- END CONTENT -->
