    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>
                 <?php
                      echo "Edycja oceny - Semestr II<br/>";
                ...
                ?>
		                ...
		                <?php
							...
							if(isset($_POST['ocena']) && $_POST['rodzaj_oceny'] && $_POST['tresc_oceny'])
							{
							  $ocena = $_POST['ocena'];
							  $rodzaj_oceny = $_POST['rodzaj_oceny'];
							  $tresc_oceny = $_POST['tresc_oceny'];
						 
							  if(mysql_query("INSERT INTO ocena_s2 VALUES('$ocena' , '$rodzaj_oceny' ,'$tresc_oceny')"))
							...
							$res = mysql_query("SELECT * FROM ocena_s2 WHERE idklasy='{$_SESSION['klasa']}' and iducznia='{$_SESSION['uczen2']}' and idprzedmiotu='{$user['idprzedmiotu']}'");
                ...
                echo "<th><strong>Edytuj</strong></th>";
                echo "</tr>";
                  ...
                  echo "<td>" . $row['tresc_oceny'] . "</td>";
                  echo "<td>" . $row['data_oceny'] . "</td>";
                  echo "<td><h4><a href='editocena_s2.php?editocena_s2=$row[idoceny]'><img src=\"../../images/edit.png\" alt=\"Edytuj\"></a></h4> </td>";
                  echo "</tr>";
                }
                echo "</table>";
                echo "</center>";
