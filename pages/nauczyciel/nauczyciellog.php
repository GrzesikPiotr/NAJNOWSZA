            ...
            <div class="content">
                ...
                <?php
                        if (user::isLogged()) {
                            ...
                            $zapytanie = "SELECT * FROM wychowawca WHERE idklasy='{$_SESSION['klasa']}'";
                           ...
                           if ( !mysql_close() ) {
                            ...
                            echo "<center><a href=\"../nauczyciel/nauczycielindex.php\"><button>Otwórz dziennik</button></a></center>";

                    }
                ?>

                <br/>
                    <a href="../zalogowanynauczyciel.php"><button>Zmień klase</button></a><br />
                <br/> 
                <!-- END CONTENT -->
