        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <?php
						...
						if( isset($_GET['edituwaga']) )
						{
							$iduwagi = $_GET['edituwaga'];
							$res= mysql_query("SELECT * FROM uwaga WHERE iduwagi='$iduwagi'");
							$row= mysql_fetch_array($res);

              echo "<center><h3>Data wystawienia: <font color=\"red\">".$row['data_dodania']."</font></h3></center><br/>";
						}
					 
						if( isset($_POST['newTresc_uwagi']))
						{
							$newTresc_uwagi = $_POST['newTresc_uwagi'];
							
							$iduwagi  	 = $_POST['iduwagi'];
							$sql     = "UPDATE uwaga SET tresc_uwagi='$newTresc_uwagi' WHERE iduwagi='$iduwagi'";
							$res 	 = mysql_query($sql) or die("Could not update" .mysql_error());
							echo "<meta http-equiv='refresh' content='0;url=edycjauwaga.php'>";
					...
					<?php
          echo "<center>
          <form action=\"edituwaga.php\" method=\"POST\">

          Treść uwagi:
          <textarea cols=\"60\" rows=\"5\" type=\"text\" name=\"newTresc_uwagi\" id=\"tresc_uwagi\">".$row['tresc_uwagi']."</textarea><br/>

          <input type=\"hidden\" name=\"iduwagi\" value=".$row['iduwagi'].">
