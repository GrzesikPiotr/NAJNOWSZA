        ...
        <div class="page-wrap">
            <div class="content">
                 ...
                 ?>
		                ...
		                <?php
							...
							if(isset($_POST['obecnosc']))
							{
							  ...
							  if(mysql_query("INSERT INTO obecnosc_s2 VALUES('$obecnosc')"))
							...
							$res = mysql_query("SELECT * FROM obecnosc_s2 WHERE idklasy='{$_SESSION['klasa']}' and iducznia='{$_SESSION['uczen2']}' and idprzedmiotu='{$user['idprzedmiotu']}' and data_obecnosci='{$_SESSION['dzien2']}' ");
                ...
                echo "</tr>";
                  ...
                  echo "<td><h4><a href='editobecnosc_s2.php?editobecnosc_s2=$row[idobecnosci]'><img src=\"../../images/edit.png\" alt=\"Edytuj\"></a></h4> </td>";
                  echo "</tr>";
                }
                echo "</table>";
                echo "</center>";
