    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>
                 <?php
                      echo "Edycja oceny - Semestr I<br/>";
                ...
                ?>
		                ...
		                <?php
							...
							if(isset($_POST['ocena']) && $_POST['rodzaj_oceny'] && $_POST['tresc_oceny'])
							{
							  ...
							  if(mysql_query("INSERT INTO ocena_s1 VALUES('$ocena' , '$rodzaj_oceny' ,'$tresc_oceny')"))
							...
							$res = mysql_query("SELECT * FROM ocena_s1 WHERE idklasy='{$_SESSION['klasa']}' and iducznia='{$_SESSION['uczen1']}' and idprzedmiotu='{$user['idprzedmiotu']}'");
                ...
                echo "</tr>";
                  ...
                  echo "<td><h4><a href='editocena_s1.php?editocena_s1=$row[idoceny]'><img src=\"../../images/edit.png\" alt=\"Edytuj\"></a></h4> </td>";
                  echo "</tr>";
                }
                echo "</table>";
                echo "</center>";
