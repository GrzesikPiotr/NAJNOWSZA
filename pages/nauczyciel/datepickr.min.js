...
c.value=d;this.close()}},x=function(a){if(a.target!=this.element&&a.target!=this.calendar&&(a=a.target.parentNode,a!=this.calender))for(;a!=this.calendar;)if(a=a.parentNode,null==a){this.close();break}};return function(a,c){var b=this;this.element=document.getElementById(a);this.config={fullCurrentMonth:!0,dateFormat:"F jS, Y",weekdays:"Niedziela Poniedziałek Wtorek Środa Czwartek Piątek Sobota".split(" "),months:"Styczeń Luty Marzec Kwiecień Maj Czerwiec Lipiec Sierpień Wrzesień Październik Listopad Grudzień".split(" "),
