    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
                <ul>    
                    ...
                    <li class="selected"><a href="administrator.php">Administrator</a></li>
                    <!-- END MENU -->
                </ul>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                 ...
                 * SKRYPT LOGOWANIA
                 */
                require_once 'class/user.class.php'; // Dołączamy rdzeń systemu użytkowników
                ...
                ?>
                        <center>
                        Cześć <b>Admin</b>. Zaloguj się do panelu admina. <br />
                         <br />
