...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Administratora - Edycja nauczyciela</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <?php
						...
						if( isset($_GET['editn']) )
						{
							$idnauczyciela = $_GET['editn'];
							$res= mysql_query("SELECT * FROM nauczyciel WHERE idnauczyciela='$idnauczyciela'");
						...
						if( isset($_POST['newName']) && $_POST['newImie2'] && $_POST['newNazwisko'] && $_POST['newDataurodzenia'] && $_POST['newWyksztalcenie'] && $_POST['newTelefon'])
						{
							...
							$sql     = "UPDATE nauczyciel SET imie='$newName', imie2='$newImie2', nazwisko='$newNazwisko' , data_urodzenia='$newDataurodzenia', wyksztalcenie='$newWyksztalcenie', telefon='$newTelefon' WHERE idnauczyciela='$idnauczyciela'";
							$res 	 = mysql_query($sql) or die("Could not update" .mysql_error());
							echo "<meta http-equiv='refresh' content='0;url=edycjan.php'>";
						}
					...
					<input type="hidden" name="idnauczyciela" value="'.$row[0].'">
					<input type="submit" value="Update"/>
					</form></center>';
					?>
					<br />
                    <a href="edycjan.php"><button>Wstecz</button></A><br />
                    <br />
