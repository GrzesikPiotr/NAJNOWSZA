            ...
            <div class="content">
                ...
                <!-- CONTENT -->
		                <?php
							...
							if(isset($_POST['imie']) && $_POST['imie2'] && $_POST['nazwisko'] && $_POST['data_urodzenia'] && $_POST['wyksztalcenie'] && $_POST['telefon'])
							{
							  $imie = $_POST['imie'];
							  $imie2 = $_POST['imie2'];
							  ...
							  if(mysql_query("INSERT INTO wychowawca VALUES($imie' , '$imie2' ,'$nazwisko', '$data_urodzenia', '$wyksztalcenie',  $telefon')"))
							...
							$res = mysql_query("SELECT * FROM wychowawca");
						 
						?>
						<h1>Lista wychowawców</h1>
						<?php
							echo "<p>";
						    ...
						    while ($row = mysql_fetch_array($res))  {
                              ...
                              echo "<td >" . $row[7] . "</td>";
                              echo "<td >" . $row[9] . "</td>";
                              echo "<td> <h4><a href='editw.php?editw=$row[idwychowawcy]'><img src=\"../../images/edit.png\" alt=\"Edytuj\"></a></h4> </td>";
                              echo "</tr>";
                           }
                           echo "</table>";
						?>
