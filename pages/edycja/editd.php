...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Administratora - Edycja dyrektora</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <?php
						...
						if( isset($_GET['editd']) )
						{
							$iddyrektora = $_GET['editd'];
							$res= mysql_query("SELECT * FROM dyrektor WHERE iddyrektora='$iddyrektora'");
						...
						if( isset($_POST['newName']) && $_POST['newImie2'] && $_POST['newNazwisko'] && $_POST['newDataurodzenia'] && $_POST['newWyksztalcenie'] && $_POST['newTelefon'])
						{
							...
							$iddyrektora  	 = $_POST['iddyrektora'];
							$sql     = "UPDATE dyrektor SET imie='$newName', imie2='$newImie2', nazwisko='$newNazwisko' , data_urodzenia='$newDataurodzenia', wyksztalcenie='$newWyksztalcenie', telefon='$newTelefon' WHERE iddyrektora='$iddyrektora'";
							$res 	 = mysql_query($sql) or die("Could not update" .mysql_error());
							echo "<meta http-equiv='refresh' content='0;url=edycjad.php'>";
						}
					...
					Numer telefonu: <input type="text" maxlength="9" name="newTelefon" value="'.$row[8].'"><br />
					<input type="hidden" name="iddyrektora" value="'.$row[0].'">
					<input type="submit" value="Update"/>
					</form></center>';
					?>
					<br />
                    <a href="edycjad.php"><button>Wstecz</button></A><br />
                    <br />
