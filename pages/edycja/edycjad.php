        ...
        <div class="page-wrap">
            <div class="content">
                ...
                $telefon = $_POST['telefon'];;
							  ...
							  if(mysql_query("INSERT INTO dyrektor VALUES('', $imie' , '$imie2' ,'$nazwisko', '$data_urodzenia', '$wyksztalcenie', '$telefon')"))
							...
							$res = mysql_query("SELECT * FROM dyrektor");
						 
						?>
						<h1>Lista dyrektorów</h1>
						<?php
							echo "<p>";
						    ...
						    while ($row = mysql_fetch_array($res))  {
                              ...
                              echo "<td >" . $row[7] . "</td>";
                              echo "<td >" . $row[8] . "</td>";
                              echo "<td> <h4><a href='editd.php?editd=$row[iddyrektora]'><img src=\"../../images/edit.png\" alt=\"Edytuj\"></a></h4> </td>";
                              echo "</tr>";
                           }
                           echo "</table>";
						?>
