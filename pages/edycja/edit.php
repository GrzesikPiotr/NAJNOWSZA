...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Administratora - Edycja użytkowników</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <?php
						...
						{
							$iducznia = $_GET['edit'];
							$res= mysql_query("SELECT * FROM uczen WHERE iducznia='$iducznia'");
							$row= mysql_fetch_array($res);
						}
					 
						if( isset($_POST['newName']) && $_POST['newImie2'] && $_POST['newNazwisko'] && $_POST['newDataurodzenia'] && $_POST['newTelefon'] && $_POST['newEmail'])
						{
							...
							$sql     = "UPDATE uczen SET imie='$newName', imie2='$newImie2', nazwisko='$newNazwisko' , data_urodzenia='$newDataurodzenia', telefon='$newTelefon', email='$newEmail' WHERE iducznia='$iducznia'";
							$res 	 = mysql_query($sql) or die("Could not update" .mysql_error());
							echo "<meta http-equiv='refresh' content='0;url=edycja.php'>";
						}
					...
					Imię: <input type="text" name="newName" value="'.$row[1].'"><br />
					Drugie imię: <input type="text" name="newImie2" value="'.$row[2].'"><br />
					Nazwisko: <input type="text" name="newNazwisko" value="'.$row[3].'"><br />
					Data Urodzenia: <input type="date" name="newDataurodzenia" value="'.$row[4].'"><br />
					Numer telefonu do rodzica: <input maxlength="9" type="text" name="newTelefon" value="'.$row[5].'"><br />
					Email do rodzica: <input type="text" name="newEmail" value="'.$row[8].'"><br />
					<input type="hidden" name="iducznia" value="'.$row[0].'">
					<input type="submit" value="Update"/>
					</form></center>';
					?>
					<br />
                    <a href="edycja.php"><button>Wstecz</button></A><br />
                    <br />
