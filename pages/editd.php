...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>PANEL ADMINISTRATORA - usuwanie dyrektora</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <!-- CONTENT -->
                             <?php
                                    $q="DELETE FROM `dyrektor` WHERE `iddyrektora` = '{$_GET['usun']}'";
                                    mysql_query($q);
                                    $rezultat = mysql_query("SELECT * FROM dyrektor order by iddyrektora ASC") or die(mysql_error());
                                    $wykonaj = mysql_num_rows($rezultat);
                                    echo "<p>Ilość Dyrektorów: ".$wykonaj."</p>";
                                   ...
                                   while ($record = mysql_fetch_array($rezultat, MYSQL_ASSOC))  {
                                      ...
                                      echo "<td >  <h4><a href=\"editd.php?usun={$record['iddyrektora']}\"><img src=\"../images/del.png\" alt=\"Usuń\" name=\"Usuń\" title=\"Usuń\"></a>&nbsp&nbsp</h4> </td>";
                                      echo "</tr>";
                                   }
                                   echo "</table>";
