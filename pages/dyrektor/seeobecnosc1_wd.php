            ...
            <div class="content">
                ...
                <?php
                        if ($_POST['send'] == 1) {
                            ...
                            $dziend1 = mysql_real_escape_string(htmlspecialchars($_POST['dziend1']));

                            $errors = ''; // Zmienna przechowująca listę błędów które wystąpiły

                            if (!$dziend1) $errors .= '<h4><center> Musisz wybrać dzień!</h4></center><br />';
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: seeobecnosc1.php\n\n");                                 
                            }
                        }
                    ?>


                <form method="post" action="seeobecnosc1.php">
                    <center>                  
                    <label for="dziend1"><strong>Pokaż obecność z dnia:</strong><input id="dziend1" name="dziend1" size="37" style="text-align: center"/></label><br /> 

                    <script type="text/javascript" src="datepickr.min.js"></script>
                    <script type="text/javascript">
                      new datepickr('dziend1', {
                        'dateFormat': 'y/m/d'
                      });
                    </script><br /> 
