<?php
    require '../config.php';
    require_once '../class/dyrektor.class.php';
?>
<?php
...
<div id="navbg">
    <div id="nav">
    <h3>Panel Dyrektora - Korespondencja</h3>
    </div>
</div>
...
<!-- CONTENT -->
<center>
<form action="zaproszenie.php" method="post">
<input name="nazwa_organu" />Podaj nazwę szkoły<br /><br />
<input name="wydarzenie" />Nazwa wydarzenia<br /><br />

<input name="data" />Data<br /><br />
<input name="godzina" />Godzina<br /><br />

<input name="adres" />Adres<br /><br />
<input name="miasto" />Miasto<br /><br />

Treść
<textarea name="informacje" cols="50" rows="10"></textarea>
<br />
<input type="radio" name="group2" value="Zpowazaniem"> Z poważaniem<br>
<input type="radio" name="group2" value="pozdrawiam"> Pozdrawiam<br>
<input type="radio" name="group2" value="Podpis" checked> Podpis<br />
<br />
<input type="submit" value="Generuj List" /><br />
<input type="reset" value="Wyczyść dane" />
</form></center>


<a href="../zalogowanydyrektor.php"><button>Powrót do panelu dyrektora</button></a><br />
<br />
<!-- END CONTENT -->
...
<li><a href="http://www.mnisw.gov.pl" title="Ministerstwo Nauki i Szkolnictwa Wyższego" onclick="this.target='_blank'">Ministerstwo Nauki i Szkolnictwa Wy?szego</a></li>
<li><a href="http://www.cie.men.gov.pl/index.php/sio-wykaz-szkol-i-placowek.html" title="Wykaz szkół i placówek oświatowych">Wykaz szk?? i plac??wek o?wiatowych</a></li>
<li><a href="http://www.men.gov.pl/podreczniki/" title="Wykaz podręczników" onclick="this.target='_blank'">Wykaz podr?cznik?w</a></li>
</ul>
...
<li><a href="http://www.zpsb.szczecin.pl" title="Zachodniopomorska Szkoła Biznesu w Szczecinie" onclick="this.target='_blank'">Zachodniopomorska Szko?a Biznesu w Szczecinie</a></li>
<li><a href="http://www.edukacja.net" title="Wszystko o uczelniach wyższych oraz o maturze" onclick="this.target='_blank'">Wszystko o uczelniach wy?szych oraz o maturze</a></li>
</ul>
<div class="clear"></div>
</div>
<div class="footer">
