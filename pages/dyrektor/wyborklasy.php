                ...
                <!-- CONTENT -->
                    ...
                    <?php
                        if ($_POST['send'] == 1) {
                            ...
                            $dklasa = mysql_real_escape_string(htmlspecialchars($_POST['dklasa']));
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: dyrektorlog.php\n\n");                                 
                            }
                        }
                    
                    ?>

                    <center><form action="dyrektorlog.php" method="post">
                    <label for="dklasa">Proszę wybrać klasę, której dane mają zostać wyświetlone:<br/> 
                    <?php                 
