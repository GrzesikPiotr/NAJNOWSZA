...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Dyrektora - Dziennik uwag uczniów</h3>
            </div>
        </div>
                ...
                <h3><center>Uwagi Klasy:  
                   ...
                   ?>
                       ...
                       <?php                       
                           ...
                           $zapytanie = "SELECT * FROM uwaga WHERE idklasy='{$_SESSION['dklasa']}' order by data_dodania DESC";
                           ...
                           echo "<th>Z jakiego przedmiotu</th>";
                           echo "<th>Data wystawienia</th>";
                           echo "<th>Nauczyciel wystawiający</th>";
