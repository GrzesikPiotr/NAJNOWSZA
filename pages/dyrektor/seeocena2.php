...
<?php
    $_SESSION['przedmiotd2']=$_POST['przedmiotd2'];
?>
...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Dyrektora - Oceny uczniów z semestru II</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>  
                   <?php
                        echo "Klasa: <font color=\"red\">" . $_SESSION['dklasa'] . "</font><br/>";
                        echo "Przedmiot: <font color=\"red\">" . $_SESSION['przedmiotd2'] . "</font><br/>";                           
                   ?>
                </center></h3><br />
                <h3><center>
                  Oceny z semestru II
                       ...
                       <?php 
                          ...
                          $rezultat = mysql_query("SELECT DISTINCT(iducznia) FROM ocena_s2 where idklasy='{$_SESSION['dklasa']}' order by iducznia ASC") or die(mysql_error());
                          
                           echo "<center>";
                           echo "<table style=\"width: 55%\">";
                           echo "<tr>";
                           echo "<th>Uczeń</th>";
                           echo "<th colspan=\"30\">Oceny</th>";
                           echo "</tr>";


                           while ($record = mysql_fetch_array($rezultat))  {
                              echo "<tr style=\"text-align: center\">";
                              echo "<td style=\"width: 25%\"><b>" . $record['iducznia'] . "</b></td>";
                              
                                $rezultat2 = mysql_query("SELECT * FROM ocena_s2 where iducznia='{$record['iducznia']}' and idprzedmiotu='{$_SESSION['przedmiotd2']}'; ") or die(mysql_error());
                                while ($row = mysql_fetch_assoc($rezultat2)) {
            
                                    echo "<td style=\"width: 15px\">" . $row['ocena'] . "</td>";
                           ...
                           mysql_close($rezultat2);
                    ?>


                          <br />
                          <a href="dziennikklasy.php"><button>Wstecz</button></a><br />
                          <br />
                <!-- END CONTENT -->
