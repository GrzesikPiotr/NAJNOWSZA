...
<?php
    $_SESSION['przedmiotd1']=$_POST['przedmiotd1'];
?>
...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Dyrektora - Oceny uczniów z semestru I</h3>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <h3><center>  
                   <?php
                        ...
                        echo "Przedmiot: <font color=\"red\">" . $_SESSION['przedmiotd1'] . "</font><br/>";                           
                   ?>
                </center></h3><br />
                <h3><center>
                  Oceny z semestru I
                       ...
                       <?php 
                          ...
                          $rezultat = mysql_query("SELECT DISTINCT(iducznia) FROM ocena_s1 where idklasy='{$_SESSION['dklasa']}' order by iducznia ASC") or die(mysql_error());
                           ...
                           while ($record = mysql_fetch_array($rezultat))  {
                              ...
                              echo "<td style=\"width: 25%\"><b>" . $record['iducznia'] . "</b></td>";
                                ...
                                $rezultat2 = mysql_query("SELECT * FROM ocena_s1 where iducznia='{$record['iducznia']}' and idprzedmiotu='{$_SESSION['przedmiotd1']}'; ") or die(mysql_error());
