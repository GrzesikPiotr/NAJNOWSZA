            ...
            <div class="content">
                ...
                <?php
                        if (user::isLogged()) {
                            ...
                            echo "<center>Wybrałeś klasę: <b>" .$_SESSION['dklasa']. "</b></center><br/>";
                ...
                <table>
                        ...
                        <tr align="center">
                            <td><font size="4"><a href="wyborklasy.php"><button>Wybierz inną klasę</button></a></font></td>
                            <td><font size="4"><a href="seeuczen.php"><button>Wyświetl listę uczniów</button></a></font></td>
                            <td><font size="4"><a href="seeuwaga.php"><button>Zobacz wystawione uwagi</button></a></font></td>                        
                            <td><font size="4"><a href="seeobecnosc1_wd.php"><button>Wyświetl obecności z semestru I</button></a></font></td>
                            <td><font size="4"><a href="seeobecnosc2_wd.php"><button>Wyświetl obecności z semestru II</button></a></font></td>
                            <td><font size="4"><a href="seeocena1_wp.php"><button>Wyświetl oceny z semestru I</button></a></font></td> 
                            <td><font size="4"><a href="seeocena2_wp.php"><button>Wyświetl oceny z semestru II</button></a></font></td>
                            <td><font size="4"><a href="seeocenakoncowa_s1.php"><button>Oceny końcowe z semestru I</button></a></font></td>
                            <td><font size="4"><a href="seeocenakoncowa_s2.php"><button>Oceny końcowe z semestru II</button></a></font></td> 
                        </tr>
                </table>
 
                <br/>
                    <a href="../zalogowanydyrektor.php"><button>Powrót do panelu głównego</button></a><br />
                <br/> 
                <!-- END CONTENT -->
