    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>Klasa:  
                 <?php
                      echo "<font color=\"red\">" . $_SESSION['dklasa'] . "</font>";                    
                 ?>
                </center></h3><br />
                    ...
                    <?php
                        if ($_POST['send'] == 1) {
                            ...
                            $przedmiotd2 = mysql_real_escape_string(htmlspecialchars($_POST['przedmiotd2']));

                            $errors = ''; // Zmienna przechowująca listę błędów które wystąpiły

                            if (!$przedmiotd2) $errors .= '<h4><center> Musisz wybrać przedmiot!</h4></center><br />';
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: ../dyrektor/seeocena2.php\n\n");                                 
                            }
                        }
                    
                    ?>

                    <center><form action="../dyrektor/seeocena2.php" method="post">
                    <label for="przedmiotd2">Proszę wybrać przedmiot do wyświetlenia ocen:<br/> 
                    <?php                 
                            $zapytanie = "SELECT * FROM przedmioty ";
                            $wynik=mysql_query($zapytanie); 
                            $myHTML="<select name=\"przedmiotd2\">";
                    ...
                    <input type="hidden" name="send" value="1" /> <button>Wybierz</button></form><br />
                    </center>

                <br/>
                    <a href="dziennikklasy.php"><button>Panel Wychowawcy</button></a><br />
                <br/>
                <!-- END CONTENT -->
