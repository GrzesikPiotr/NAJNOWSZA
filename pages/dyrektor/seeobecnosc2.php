...
<?php
    $_SESSION['dziend2']=$_POST['dziend2'];
?>
...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Dyrektora - Lista obecności</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>Dzień:  
                   <?php
                        echo "<font color=\"red\">" . $_SESSION['dziend2'] . "&nbsp</font>";
                        echo "<a href=\"../dyrektor/seeobecnosc2_wd.php\"><button>Wybierz nową datę</button></a>";                          
                   ?>
                </center></h3><br />

                      <?php                       
                           //Definiujemy zapytanie pobierające wszystkie wiersze z wszystkimi
                           $zapytanie = "SELECT * FROM obecnosc_s2 WHERE idklasy='{$_SESSION['dklasa']}' and data_obecnosci='{$_SESSION['dziend2']}' order by idprzedmiotu, iducznia ASC";
                           ...
                           echo "<th><strong>Dzień</strong></th>";
                           ...
                           while ( $row = mysql_fetch_array($wynik) ) {
                              ...
                              echo "<td>" . $row['data_obecnosci'] . "</td>";
                              echo "<td>" . $row['idnauczyciela'] . "</td>";
                              echo "</tr>";
                           }
                           echo "</table>";
                           echo "</center><br/>";
                ...
                <br />
                    <a href="../dyrektor/dziennikklasy.php"><button>Wstecz</button></a><br />
                <br />
                <!-- END CONTENT -->
