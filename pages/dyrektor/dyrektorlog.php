            ...
            <div class="content">
                ...
                <?php
                        if (user::isLogged()) {
                            ...
                            $zapytanie = "SELECT * FROM wychowawca WHERE idklasy='{$_SESSION['dklasa']}'";
                             $wynik = mysql_query($zapytanie);
                             while ( $row = mysql_fetch_array($wynik) ) {
                              echo "<center>Wychowawca klasy: ";
                                echo "<b>" . $row['imie'] . "</b>";
                                echo "<b> " . $row['nazwisko'] . "</b></center><br/>";
                             }

                            echo "<center><a href=\"dziennikklasy.php\"><button>Przejdź do klasy</button></a></center>";
                ...
                <br/>
                    <a href="../zalogowanydyrektor.php"><button>Powrót do panelu głównego</button></a>
                    <a href="wyborklasy.php"><button>Zmień klase</button></a><br/>
                <br/> 
                <!-- END CONTENT -->
