    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <!-- CONTENT -->
                <?php
                $zapytanie = mysql_query("SELECT * FROM uczen");
                ...
                ?>
                    ...
                    <label for="to"><strong>ADRESAT:</strong><br />
                      <?php
                        ...
                        $r=mysql_query($sql);
                        $myHTML="<select name=\"to\">";
                        while($x=mysql_fetch_assoc($r)) {
                        $myHTML.="<option value=\"{$x['telefon']}\" >{$x['telefon']}, {$x['imieopiekun']} {$x['nazwiskoopiekun']} </option>";
                        }
                        $myHTML.="</select><br />";
                        print $myHTML;
                        ?></label><br />
                    <label for="message"><strong>WIADOMOŚĆ:</strong><textarea name="message" cols="30" rows="6" /></textarea><br />
