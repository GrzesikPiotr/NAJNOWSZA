...
<?php
    $_SESSION['dzienw2']=$_POST['dzienw2'];
?>
    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>Dzień:  
                   <?php
                        echo "<font color=\"red\">" . $_SESSION['dzienw2'] . "&nbsp</font>";
                        echo "<a href=\"../wychowawca/seeobecnosc2_wd.php\"><button>Wybierz nową datę</button></a>";                          
                   ?>
                </center></h3><br />

                      <?php                       
                           //Definiujemy zapytanie pobierające wszystkie wiersze z wszystkimi
                           $zapytanie = "SELECT * FROM obecnosc_s2 WHERE idklasy='{$_SESSION['wklasa']}' and data_obecnosci='{$_SESSION['dzienw2']}' order by idprzedmiotu, iducznia ASC";
