            ...
            <div class="content">
                ...
                <table>
                  ...
                  <tr style="text-align: center">
                    <th>Formularz kontaktowy</th>
                    <th colspan="2">Informacje ocen</th>
                  ...
                  <tr style="text-align: center">
                    ...
                    <td colspan="2" valign="top">
                      <?php
                          ...
                          $zapytanie = "SELECT * FROM ocena_s1 WHERE idklasy='{$_SESSION['wklasa']}' order by iducznia, idprzedmiotu ASC;";
                          $wynik = mysql_query($zapytanie);
                            ...
                            mysql_close($zapytanie);
                      ?>
                    </td>

                    <td valign="top">
                      <?php
                          $zapytanie2 = "SELECT * FROM uczen WHERE idklasy='{$_SESSION['wklasa']}';";
                          $wynik2 = mysql_query($zapytanie2);
                            ...
                            echo "<tr style=\"text-align: center\">";
                            echo "<th>Uczeń</th>";
                            echo "<th>Opiekun prawny</th>";
                            echo "<th>E-mail</th>";
                            echo "</tr>";

                            while ( $row2 = mysql_fetch_array($wynik2) ) {
                            echo "<tr style=\"text-align: center\">";
                            echo "<td>". $row2['nazwisko'] . "&nbsp;" . $row2['imie'] ."</td>";
                            echo "<td>". $row2['nazwiskoopiekun'] . "&nbsp;" . $row2['imieopiekun'] ."</td>";
