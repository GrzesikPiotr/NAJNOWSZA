...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Wychowawcy - powiadomienia mailowe</h3>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <table style="width: 90%">
                  ...
                  <tr style="text-align: center">
                    ...
                    <th colspan="3">Informacje kontaktowe</th>
                  </tr>


                  <tr style="text-align: center">
                    <th valign="top" style="width: 500px">
                        <?php 
                          include('mail.php'); 
                        ?>
                    </th>
                    ...
                    <td colspan="3" valign="top">
                      ...
                      <?php
                          $zapytanie = "SELECT * FROM uczen WHERE idklasy='{$_SESSION['wklasa']}';";
                          $wynik = mysql_query($zapytanie);
                            ...
                            echo "<tr style=\"text-align: center\">";
                            echo "<td>" . $row['nazwisko'] ."&nbsp". $row['imie'] . "</td>";
                            echo "<td>" . $row['nazwiskoopiekun'] ."&nbsp". $row['imieopiekun'] . "</td>";
