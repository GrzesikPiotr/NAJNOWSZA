    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                 ...
                 ?>
                    ...
                    <?php
                        if ($_POST['send'] == 1) {
                            ...
                            $przedmiotw2 = mysql_real_escape_string(htmlspecialchars($_POST['przedmiotw2']));

                            $errors = ''; // Zmienna przechowująca listę błędów które wystąpiły

                            if (!$przedmiotw2) $errors .= '<h4><center> Musisz wybrać przedmiot!</h4></center><br />';
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: ../wychowawca/seeocena2.php\n\n");                                 
                            }
                        }
                    
                    ?>

                    <center><form action="../wychowawca/seeocena2.php" method="post">
                    <label for="przedmiotw2">Proszę wybrać przedmiot do wyświetlenia ocen:<br/> 
                    <?php                 
                            $zapytanie = "SELECT * FROM przedmioty ";
                            $wynik=mysql_query($zapytanie); 
                            $myHTML="<select name=\"przedmiotw2\">";
                ...
                <br/>
                    <a href="../zalogowanywychowawca.php"><button>Panel Wychowawcy</button></a><br />
                <br/>
                <!-- END CONTENT -->
