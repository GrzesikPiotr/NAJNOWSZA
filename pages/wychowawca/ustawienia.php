...
$valid['wychowawca'] = 2 ; 	// Nick: 0 - oznacza pole nieobowiązkowe, inna liczba minimalną ilość znaków jakie musi wpisać użytkownik
...
$komunikat['wychowawca'] = 'Wychowawca musi mieć min. 2 znaki.'; 	//Wpisz właściwą ilość znaków jeśli pole wymagane
