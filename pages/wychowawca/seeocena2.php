...
<?php
    $_SESSION['przedmiotw2']=$_POST['przedmiotw2'];
?>
...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Wychowawcy - Oceny uczniów Semestr II</h3>
            </div>
        </div>
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>  
                   <?php
                        echo "Klasa: <font color=\"red\">" . $_SESSION['wklasa'] . "</font><br/>";
                        echo "Przedmiot: <font color=\"red\">" . $_SESSION['przedmiotw2'] . "</font>";                           
                   ?>
                </center></h3><br />
                <h3><center>
                  Oceny z semestru I
                       ...
                       <?php 
                          ...
                          $rezultat = mysql_query("SELECT DISTINCT(iducznia) FROM ocena_s2 where idklasy='{$_SESSION['wklasa']}' order by iducznia ASC") or die(mysql_error());
                           ...
                           while ($record = mysql_fetch_array($rezultat))  {
                              ...
                              echo "<td style=\"width: 25%\"><b>" . $record['iducznia'] . "</b></td>";
                                ...
                                $rezultat2 = mysql_query("SELECT * FROM ocena_s2 where iducznia='{$record['iducznia']}' and idprzedmiotu='{$_SESSION['przedmiotw2']}'; ") or die(mysql_error());
