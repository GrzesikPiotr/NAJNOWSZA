	...
	<?php
			...
			echo "<form action=\"#strona#\" method=\"post\" id=\"formularz\">";
				...
				echo "<div>";
					...
					echo '<label for="temat">
                    <select name="temat">
                    <option value="wybierz" selected="selected">Wybierz...</option>
                    <option value="Nalezy_jak_najszybciej_poprawic_oceny">Należy jak najszybciej poprawić oceny</option>
                    <option value="oceny_sa_na_poziomie_srednim">Oceny są na poziomie średnim</option>
                    <option value="bardzo_dobre_oceny">Gratuluję. Bardzo dobre oceny</option>
                    </select></label>';
				...
				echo "<div>";
					...
					echo "<textarea cols=\"40\" rows=\"10\" id=\"tresc\" name=\"tresc\" >#tresc#</textarea>";
				echo "</div><br/>";
