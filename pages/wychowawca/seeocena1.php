...
<?php
    $_SESSION['przedmiotw1']=$_POST['przedmiotw1'];
?>
...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Wychowawcy - Oceny uczniów Semestr I</h3>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <h3><center>  
                   <?php
                        ...
                        echo "Przedmiot: <font color=\"red\">" . $_SESSION['przedmiotw1'] . "</font>";                           
                   ?>
                </center></h3><br />
                <h3><center>
                  Oceny z semestru I
                      ...
                      <?php 
                          ...
                          $rezultat = mysql_query("SELECT DISTINCT(iducznia) FROM ocena_s1 where idklasy='{$_SESSION['wklasa']}' order by iducznia ASC") or die(mysql_error());
                           ...
                           while ($record = mysql_fetch_array($rezultat))  {
                              ...
                              echo "<td style=\"width: 25%\"><b>" . $record['iducznia'] . "</b></td>";
                                ...
                                $rezultat2 = mysql_query("SELECT * FROM ocena_s1 where iducznia='{$record['iducznia']}' and idprzedmiotu='{$_SESSION['przedmiotw1']}'; ") or die(mysql_error());
