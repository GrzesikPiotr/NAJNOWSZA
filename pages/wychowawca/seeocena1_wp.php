                 ...
                 ?>
                    ...
                    <?php
                        if ($_POST['send'] == 1) {
                            ...
                            $przedmiotw1 = mysql_real_escape_string(htmlspecialchars($_POST['przedmiotw1']));

                            $errors = ''; // Zmienna przechowująca listę błędów które wystąpiły

                            if (!$przedmiotw1) $errors .= '<h4><center> Musisz wybrać przedmiot!</h4></center><br />';
                            ...
                            if ($errors != '') {
                                echo '<center><p class="error"><center><h4>Popraw błąd: </h4></center><br />'.$errors.'</p></center>';
                                 ...
                                 header("Location: ../wychowawca/seeocena1.php\n\n");                                 
                            }
                        }
                    
                    ?>

                    <center><form action="../wychowawca/seeocena1.php" method="post">
                    <label for="przedmiotw1">Proszę wybrać przedmiot do wyświetlenia ocen:<br/> 
                    <?php                 
                            $zapytanie = "SELECT * FROM przedmioty ";
                            $wynik=mysql_query($zapytanie); 
                            $myHTML="<select name=\"przedmiotw1\">";
