            ...
            <div class="content">
                ...
                <?php
                        if ($_POST['send'] == 1) {
                            ...
                            $dzienw2 = mysql_real_escape_string(htmlspecialchars($_POST['dzienw2']));

                            $errors = ''; // Zmienna przechowująca listę błędów które wystąpiły

                            if (!$dzienw2) $errors .= '<h4><center> Musisz wybrać dzień!</h4></center><br />';
                ...
                <form method="post" action="seeobecnosc2.php">
                    <center>                  
                    <label for="dzienw2"><strong>Pokaż obecność z dnia:</strong><input id="dzienw2" name="dzienw2" size="37" style="text-align: center"/></label><br /> 

                    <script type="text/javascript" src="datepickr.min.js"></script>
                    <script type="text/javascript">
                      new datepickr('dzienw2', {
                        'dateFormat': 'y/m/d'
                      });
                    </script><br /> 
