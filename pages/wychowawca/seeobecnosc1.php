...
<?php
    $_SESSION['dzienw1']=$_POST['dzienw1'];
?>
    ...
    <div class="page">
        ...
        <div class="page-wrap">
            <div class="content">
                ...
                <h3><center>Dzień:  
                   <?php
                        echo "<font color=\"red\">" . $_SESSION['dzienw1'] . "&nbsp</font>";
                        echo "<a href=\"../wychowawca/seeobecnosc1_wd.php\"><button>Wybierz nową datę</button></a>";                          
                   ?>
                </center></h3><br />

                      <?php                       
                           //Definiujemy zapytanie pobierające wszystkie wiersze z wszystkimi
                           $zapytanie = "SELECT * FROM obecnosc_s1 WHERE idklasy='{$_SESSION['wklasa']}' and data_obecnosci='{$_SESSION['dzienw1']}' order by idprzedmiotu, iducznia ASC";
