...
<div id="wrap">
    ...
    <div class="page">
        <div id="navbg">
            <div id="nav">
               <h3>Panel Wychowawcy - Lista obecności</h3>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <?php
                        if ($_POST['send'] == 1) {
                            ...
                            $dzienw1 = mysql_real_escape_string(htmlspecialchars($_POST['dzienw1']));

                            $errors = ''; // Zmienna przechowująca listę błędów które wystąpiły

                            if (!$dzienw1) $errors .= '<h4><center> Musisz wybrać dzień!</h4></center><br />';
                ...
                <form method="post" action="seeobecnosc1.php">
                    <center>                  
                    <label for="dzienw1"><strong>Pokaż obecność z dnia:</strong><input id="dzienw1" name="dzienw1" size="37" style="text-align: center"/></label><br /> 

                    <script type="text/javascript" src="datepickr.min.js"></script>
                    <script type="text/javascript">
                      new datepickr('dzienw1', {
                        'dateFormat': 'y/m/d'
                      });
                    </script><br /> 
