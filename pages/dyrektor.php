        ...
        <div id="navbg">
            <div id="nav">
                <ul>    
                    ...
                    <li class="selected"><a href="dyrektor.php">Dyrektor</a></li>
                    <li><a href="nauczyciel.php">Nauczyciel</a></li>
                    <li><a href="wychowawca.php">Wychowawca</a></li>
            ...
            <div class="content">
                ...
                <!-- CONTENT -->
                        <?php
                             ...
                             * SKRYPT LOGOWANIA
                             */
                            require_once 'class/dyrektor.class.php'; // Dołączamy rdzeń systemu użytkowników
                           ...
                           // Zabezpiecz zmienne odebrane z formularza, przed atakami SQL Injection
                            ...
                            if ($_POST['send'] == 1) {
                                ...
                                $userExists = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM dyrektor WHERE login = '$login' AND pass = '$pass'"));
                                ...
                                if ($userExists[0] == 0) {
                                    ...
                                    echo '<center><p class="error"><h4>Użytkownik o podanym loginie lub haśle nie istnieje.</h4></p></center>';
                                        ...
                                        $_SESSION['pass'] = $pass;
                                        header("Location: zalogowanydyrektor.php\n\n");
                                        echo '<center><p class="success">Zostałeś zalogowany. Możesz przejść na <a href="adminindex.php"><button>stronę panelu admina</button></a> 
                                        lub możesz <a href="../log/logout.php"><button>Wylogować</button></a> się </center>';
                        ...
                        <center>
                        Witam <b>Dyrektorze</b>. Wypełnij pola aby zalogować się. <br />
                        <br />
